...
Activate modules::
    ...
    >>> config = activate_modules('account_invoice_sale_relation')
...
Check invoice::
    ...
    >>> # invoice.invoice_shipments == [shipment]
    >>> invoice.invoice_shipment_returns == []
    True

    >>> line1, line2 = invoice.lines
    >>> line1.invoice_shipments == [shipment]
    True
    >>> line1.invoice_shipments == [shipment]
    True
    >>> line2.invoice_shipment_returns == []
    True
    >>> line2.invoice_shipment_returns == []
    True
    ...
    >>> invoices = Invoice.find([('invoice_shipments', '=', '1')])
    >>> len(invoices) == 1
    True
